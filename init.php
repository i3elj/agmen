...
if (!defined('WEB_DIR'))             define('WEB_DIR'             , 'src/views/');
if (!defined('COMPONENTS_DIR_NAME')) define('COMPONENTS_DIR_NAME' , 'snippets/');
...
if (!defined('ERROR_PAGES_DIR'))     define('ERROR_PAGES_DIR'     , 'src/views/errors/');
