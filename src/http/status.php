 ...
 */
function found(bool $kill = true): void
{
 ...
 */
function conflict(bool $kill = true): void
{
 ...
 * [mdn web docs](https://developer.mozilla.org/en-US/docs/Web/HTTP/Reference/Status/409).
 */
function unprocessable_content(bool $kill = true): void
{
 ...
 */
function internal_server_error(bool $kill = true): void
{
